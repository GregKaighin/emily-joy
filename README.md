...
- [Firebase Realtime Database](https://firebase.google.com/products/realtime-database) — upcoming gigs data (shared with emilyandgregduo.co.uk)
...
Gig data is stored in [Firebase Realtime Database](https://firebase.google.com/products/realtime-database) and shared with [emilyandgregduo.co.uk](https://emilyandgregduo.co.uk) — gigs entered on either admin page appear on both sites.
...
- **Login:** use your Firebase Authentication email and password
- **Add a gig:** fill in date, venue, and act (Emily Joy or Emily & Greg Duo), click Add
